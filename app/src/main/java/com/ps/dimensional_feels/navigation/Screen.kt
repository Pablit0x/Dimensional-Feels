...
sealed class Screen(val route: String) {
    ...
    object Calendar : Screen(route = Routes.CALENDAR_WITH_ARGS) {
        fun passCurrentDate(currentDateMillis: Long) =
            "${Routes.CALENDAR}?$CALENDAR_SCREEN_ARGUMENT_KEY=$currentDateMillis"
    }
}